...
from teachDRL.gym_flowers.envs.bodies.climbers.ClimberAbstractBody import ClimberAbstractBody
from teachDRL.gym_flowers.envs.utils.custom_user_data import CustomBodyUserData, CustomMotorUserData, CustomBodySensoUserData
...
class ClimbingChestProfileChimpanzee(ClimberAbstractBody):
    def __init__(self, scale, motors_torque = 100, nb_steps_under_water = 600, leg_s=1):
        ...
        self.LIMB_W, self.LIMB_H = 8 / self.SCALE, (28 / self.SCALE)*leg_s
