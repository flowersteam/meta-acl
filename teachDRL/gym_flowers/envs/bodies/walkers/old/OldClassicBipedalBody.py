...
from teachDRL.gym_flowers.envs.bodies.walkers.WalkerAbstractBody import WalkerAbstractBody
from teachDRL.gym_flowers.envs.utils.custom_user_data import CustomBodyUserData, CustomMotorUserData
...
class OldClassicBipedalBody(WalkerAbstractBody):
    ...
    def draw(self, world, init_x, init_y, force_to_center):
        ...
        for i in [-1, +1]:
            ...
            leg.userData = CustomBodyUserData(True, name="leg")
